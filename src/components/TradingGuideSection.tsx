...
const TradingGuideSection = () => {
  ...
  return (
    <section id="trading-guide" className="py-16 sm:py-24">
      <div
        ref={ref}
        ...
        <div className="space-y-8">
          {steps.map((s, i) => (
            <div key={i} className="flex gap-5">
              <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-[#5227FF] text-white flex items-center justify-center text-sm font-bold">
                {s.num}
              </div>
              <div className="pt-1">
